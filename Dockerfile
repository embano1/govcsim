...
RUN go get -u github.com/vmware/govmomi/govc@v0.25.0
...
ARG RELEASE
LABEL vcsim=0.25.0 \
      maintainer="markus.kraus@mycloudrevolution.com"
...
USER vcsim
EXPOSE 8989
CMD ["/usr/local/bin/vcsim", "-l", ":8989", "-username", "administrator", "-password", "REPLACEME", "-vm", "10"]
